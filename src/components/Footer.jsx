    ...
    <footer>
      <div className="advantages center">
        <article className="advantages__item">
          <img className="advantages__img" src="../img/footer1.svg" alt="" />
        ...
        <article className="advantages__item">
          <img className="advantages__img" src="../img/footer2.svg" alt="" />
        ...
        <article className="advantages__item">
          <img className="advantages__img" src="../img/footer3.svg" alt="" />
